package net.madz.lifecycle.demo.multiple;
import net.madz.demo.basic.ConsoleLoggingTestBase;
...
public class MultipleStateMachineTestMetadata extends ConsoleLoggingTestBase{
