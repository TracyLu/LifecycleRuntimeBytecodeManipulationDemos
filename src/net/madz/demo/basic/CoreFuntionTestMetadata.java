...
import net.madz.demo.basic.CoreFuntionTestMetadata.CustomerLifecycleMeta.States.Draft;
import net.madz.demo.basic.CoreFuntionTestMetadata.InternetTVServiceLifecycle.Relations.TVProvider;
import net.madz.demo.basic.CoreFuntionTestMetadata.KeyBoardLifecycleMetadataPreValidateCondition.Conditions.TimesLeft;
import net.madz.demo.basic.CoreFuntionTestMetadata.KeyBoardLifecycleMetadataPreValidateCondition.Relations.PowerRelation;
import net.madz.demo.basic.CoreFuntionTestMetadata.KeyBoardLifecycleMetadataPreValidateCondition.Transitions.PressAnyKey;
import net.madz.demo.basic.CoreFuntionTestMetadata.PowerLifecycleMetadata.Conditions.PowerLeftCondition;
import net.madz.demo.basic.CoreFuntionTestMetadata.PowerLifecycleMetadata.Transitions.ReducePower;
import net.madz.demo.basic.CoreFuntionTestMetadata.PowerLifecycleMetadata.Transitions.ShutDown;
import net.madz.demo.basic.CoreFuntionTestMetadata.ServiceProviderLifecycle.States.ServiceAvailable;
