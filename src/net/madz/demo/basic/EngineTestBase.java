...
import net.madz.demo.basic.CoreFuntionTestMetadata.Customer;
import net.madz.demo.basic.CoreFuntionTestMetadata.InternetServiceLifecycleMeta;
import net.madz.demo.basic.CoreFuntionTestMetadata.ServiceProviderLifecycle;
